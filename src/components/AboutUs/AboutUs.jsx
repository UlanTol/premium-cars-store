  ...
  return (
    <Container sx={{ marginTop: "50px" }}>
      ...
      <Box sx={{ marginTop: "30px" }}>
        ...
        clear: to give everyone the opportunity to rent "their" sports car - and
        do it flexibly, affordably and with the greatest possible customer
        ...
        Experience in the rental and automotive sectors • Professional customer
        support • Technical know-how • Transparency and fairness • Flexibility •
        Own vehicles Whether you just want to rent your dream sports car for an
        ...
        well-maintained vehicles round off our overall package. Get to know our
        passion and experience what it's all about. We look forward to you!
      </Box>
    </Container>
  );
};
